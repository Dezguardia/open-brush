...
public class OculusLogging
{
    ...
    public string[] datasToLog = new string[74];
    ...
    public void SetHeadsetBoolValues(
        ...
        bool isHeadSetFixationPoint,
        bool isHeadSetLeftEyeOpenAmount,
        bool isHeadSetRightEyeOpenAmount)
    {
        ...
        this.isHeadSetFixationPoint = isHeadSetFixationPoint;
        this.isHeadSetLeftEyeOpenAmount = isHeadSetLeftEyeOpenAmount;
        this.isHeadSetRightEyeOpenAmount = isHeadSetRightEyeOpenAmount;
    ...
    private void GetLeftControllerData(InputDevice leftController)
    {
        ...
        //Impossible de le get
        //if (leftTriggerTouch)
        //{
        //    if (leftController.TryGetFeatureValue(CommonUsages., out bool leftControllerTriggerTouch))
        //    {
        //        Debug.Log("Left trigger touch = " + leftControllerTriggerTouch.ToString());
        //    }
        //}
    ...
    private void GetRightControllerData(InputDevice rightController)
    {
        ...
        //Impossible de le get
        //if (rightTriggerTouch)
        //{
        //    if (rightController.TryGetFeatureValue(CommonUsages., out bool rightControllerTriggerTouch))
        //    {
        //        Debug.Log("Right trigger touch = " + rightControllerTriggerTouch.ToString());
        //    }
        //}
    ...
    private void GetHeadsetData(InputDevice headMountedDisplay)
    {
        ...
        if (isHeadSetFixationPoint || isHeadSetLeftEyeOpenAmount || isHeadSetRightEyeOpenAmount)
        {
            if (headMountedDisplay.TryGetFeatureValue(CommonUsages.eyesData, out Eyes eyesData))
            {
                if (isHeadSetFixationPoint)
                {
                    ...
                    {
                        this.datasToLog[71] = fixationPoint.ToString();
                    }
                }

                if (isHeadSetLeftEyeOpenAmount)
                {
                    if (eyesData.TryGetLeftEyeOpenAmount(out float leftOpenAmount))
                    {
                        this.datasToLog[72] = leftOpenAmount.ToString();
                    }
                }


                if (isHeadSetRightEyeOpenAmount)
                {
                    if (eyesData.TryGetRightEyeOpenAmount(out float rightOpenAmount))
                    {
                        this.datasToLog[73] = rightOpenAmount.ToString();
                    }
                }
                ...
                if (isHeadSetLeftEyePosition)
                {
                    ...
                    {
                        this.datasToLog[46] = leftEyePosition.ToString();
                    }
                }

                if (isHeadSetLeftEyeRotation)
                {
                    if (eyesData.TryGetRightEyeRotation(out Quaternion rightEyeRotation))
                    {
                        this.datasToLog[47] = rightEyeRotation.ToString();
                    }
                }

                if (isHeadSetRightEyePosition)
                {
                    if (eyesData.TryGetRightEyePosition(out Vector3 rightEyePostion))
                    {
                        this.datasToLog[52] = rightEyePostion.ToString();
                    }
                }
                ...
                if (isHeadSetRightEyeRotation)
                {
                    if (eyesData.TryGetRightEyeRotation(out Quaternion rightEyeRotation))
                    {
                        this.datasToLog[53] = rightEyeRotation.ToString();
                    }
                }
            }
        }
